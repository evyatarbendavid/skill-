...
> until re-checked. See [`live-verification-map.md`](./live-verification-map.md)
> for what to re-verify and how.
...
Property-level detail is in [`structured-data-schemas.md`](./structured-data-schemas.md).
...
> supported — see `live-verification-map.md`.
